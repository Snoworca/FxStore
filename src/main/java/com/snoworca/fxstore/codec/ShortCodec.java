...
/**
 * Codec for Short values using CANONICAL mode (stored as I64).
 */
public final class ShortCodec implements FxCodec<Short> {
    ...
    public Short decode(byte[] bytes) {
        ...
        if (val < Short.MIN_VALUE || val > Short.MAX_VALUE) {
            throw new ArithmeticException("Value out of Short range: " + val);
        }
        return (short) val;
    }
